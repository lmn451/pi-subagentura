// ralplan — a skill translated into executable workflow code
...
export const meta = {
  name: "ralplan",
  description:
    "Reference skill-to-workflow translation of RALPLAN with verified artifacts, isolated reviews, bounded revision, and pending approval.",
