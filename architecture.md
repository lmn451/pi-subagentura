...
|  49 | `src/tools/orchestrator.ts`                  | Orchestratorv2 routing metadata tools and user confirmation flow                                                                | `tool-guidance`, `orchestrator-routing`, `completion-turn`, `routing-factory`, `tools/orchestrator-router`, `session-scope`                                                                                                                                                                                             |
