...
- **TypeScript, ESM, strict mode**, `target: ESNext`, Node ≥ 22.19, Pi SDK ≥ 0.80.6. CI verifies the minimum Node runtime and both the minimum and latest published Pi SDKs.
